...
builder.Services.AddSerilogWithCloudWatch(builder.Configuration, "CatalogService");
builder.Host.UseSerilog();

// Add CloudWatch observability (metrics + logging)
builder.Services.AddCloudWatchObservability(builder.Configuration, "CatalogService");
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "RealServ Catalog Service API",
        Version = "v1",
        Description = "Material and labor catalog management service for RealServ platform"
    });
...
builder.Services.AddScoped<ILaborCategoryRepository, LaborRepository>(); // Alias
builder.Services.AddScoped<IVendorInventoryRepository, VendorInventoryRepository>();
builder.Services.AddScoped<IVendorLaborAvailabilityRepository, VendorLaborAvailabilityRepository>();
